...
<img src="https://readme-typing-svg.demolab.com?font=Space+Mono&weight=700&size=22&pause=1000&color=FFFFFF&center=true&vCenter=true&width=500&lines=SOFTWARE+ENGINEER;TECH+ENTHUSIAST+%26+LIFELONG+LEARNER" alt="Typing SVG" />

**SOFTWARE ENGINEERING STUDENT • BUITEMS • QUETTA, PAKISTAN**
...
┌────────────────────────────────────────────────────────────────┐
│  PROGRAMMING                                                   │
│  ► C, C++, Python, PHP, JavaScript, MySQL                      │
├────────────────────────────────────────────────────────────────┤
│  WEB DEVELOPMENT                                               │
│  ► HTML5, CSS3, UI/UX Principles                               │
├────────────────────────────────────────────────────────────────┤
│  DESIGN TOOLS                                                  │
│  ► Figma, Canva                                                │
├────────────────────────────────────────────────────────────────┤
